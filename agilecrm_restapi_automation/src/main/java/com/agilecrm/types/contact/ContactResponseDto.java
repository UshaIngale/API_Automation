...
public class ContactResponseDto {
    ...
    private ContactResponseViewedDto viewed;
    private int star_value;
    private int lead_score;
    private String klout_score;
    private List<String> tags;
    private List<TagWithTimeContactResponseDto> tagsWithTime;
    ...
    @JsonProperty("viewed")
    public ContactResponseViewedDto getViewed() {
        return viewed;
    }

    public void setViewed(ContactResponseViewedDto viewed) {
        this.viewed = viewed;
    }
    ...
    public List<TagWithTimeContactResponseDto> getTagsWithTime() {
        return tagsWithTime;
    }

    public void setTagsWithTime(List<TagWithTimeContactResponseDto> tagsWithTime) {
